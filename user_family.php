        ...
        <div class="container">
            <div class="row" style="margin-top: 30px;">
                ...
                <div class="col-md-4 py-3">
                    <div class="card">
                        <img src="asset/Bajak Laut.jpg" class="card-img-top" alt="Bajak Laut">
                        <div class="card-body">
                            <h3>Bajak Laut</h3>
                            <div class="star">
                ...
                <div class="col-md-4 py-3">
                    <div class="card">
                        <img src="asset/3.png" class="card-img-top" alt="Wagos">
                        <div class="card-body">
                            <h3>Wagos</h3>
                            <div class="star">
                                <i class="fa-solid fa-star checked"></i>
